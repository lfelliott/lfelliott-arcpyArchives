...
# DM.SelectLayerByAttribute(layername, "NEW_SELECTION", "\"central_objects.Basin\" = 'Edwards Plateau' and ( \"central_objects.riparian24\" = 1  or \"central_objects.Vegname\" like '%Riparian%' or \"central_objects.Vegname\" = 'Ramadero')")
...
# DM.SelectLayerByAttribute(layername, "NEW_SELECTION", "\"central_objects.Basin\" = 'Tamaulipan' and ( \"central_objects.riparian24\" = 1  or \"central_objects.Vegname\" like '%Riparian%' or \"central_objects.Vegname\" = 'Ramadero')")
...
DM.CalculateField(layername, "VegName", "\"Edwards Plateau: Wooded Cliff/Bluff\"", "VB", "")
...
DM.CalculateField(layername, "VegName", "\"Edwards Plateau: Barren or Grassy Cliff/Bluff\"", "VB", "")
print "process time = " + elapsed_time(processstart)
